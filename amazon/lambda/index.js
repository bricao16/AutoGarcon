...
// when base alexa mode, this intent is for words like "open/launch auto garcon"
...
// intent that gets the menu using an http call, then converts it to string for recitation
